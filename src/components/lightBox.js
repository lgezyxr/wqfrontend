                      ...
                      <Item.Content verticalAlign="middle">
                        ...
                        <Item.Description>
                          ...
                          <Form>
                            ...
                            <Button
                              disabled={this.props.isPublic}
                              onClick={()=>{this.props.dispatch(generatePhotoIm2txtCaption(this.props.idx2hash[this.props.lightboxImageIndex], this.state.caption_text))}}
                              floated="left"
                              size="small"
                              color="green"
                            >
                      ...
                      <Item.Content verticalAlign="middle">
                        ...
                        <Item.Description>
                          <Form>
                            ...
                            <Button
                              loading={this.props.predictingResult}
                              onClick={()=>{this.props.dispatch(predictPhoto(this.props.idx2hash[this.props.lightboxImageIndex]))}}
                              disabled={this.props.isPublic | this.props.predictingResult}
                              floated="left"
                              size="small"
                              color="blue"
                            >
                            ...
                            <Button
                              loading={this.props.predictingResult}
                              onClick={()=>{this.props.dispatch(fetchPhotoDetail(this.props.idx2hash[this.props.lightboxImageIndex]))}}
                              floated="left"
                              size="small"
                              color="blue"
                            >
